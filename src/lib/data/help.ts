    ...
    sections: [
      {
        ...
        steps: {
          en: [
            ...
            'On a profile, click Save to add the company to your Watchlist, or use the “Register a company in France” guidance card.',
          ],
          fr: [
            ...
            'Sur une fiche, cliquez Enregistrer pour l’ajouter à votre Liste de suivi, ou utilisez la carte « Créer une société en France ».',
          ],
          zh: [
            '在搜索框输入公司名、SIREN 或 SIRET。',
            '展开一行查看增值税号、营业额、财务年度与高管。',
            '打开完整档案：多年财务、股东、BODACC 法律事件、公司新闻与 AI 简报。',
            '在档案页点「收藏」加入关注列表，或使用「在法国注册公司」指引卡。',
          ],
        },
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        id: 'signals',
        href: '/signals',
        title: { en: 'Funding signals', fr: 'Signaux de levées', zh: '融资动向' },
        intro: {
          en: 'French companies that just raised money — fresh budget means strong buying intent.',
          fr: 'Entreprises françaises qui viennent de lever des fonds — budget frais = forte intention d’achat.',
          zh: '刚完成融资的法国公司——新预算意味着强采购意向。',
        },
        steps: {
          en: [
            'The list loads automatically with company, amount, round and an intent score; filter by sector or company.',
            'Resolved companies link to their full profile; click Save to track them.',
          ],
          fr: [
            'La liste se charge automatiquement (entreprise, montant, tour, score) ; filtrez par secteur ou entreprise.',
            'Les entreprises identifiées ouvrent leur fiche ; cliquez Enregistrer pour les suivre.',
          ],
          zh: [
            '列表自动加载（公司、金额、轮次、意向分）；可按行业或公司筛选。',
            '解析到的公司可点进档案，点「收藏」跟进。',
          ],
        },
      },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        intro: {
          en: 'Generate consultant-grade reports in seconds.',
          fr: 'Générez des rapports de niveau conseil en quelques secondes.',
          zh: '几秒生成咨询级报告。',
        },
        steps: {
          en: ['Pick a template (company, due diligence, market entry, sector…), enter a topic, and generate; export to PDF or markdown.'],
          fr: ['Choisissez un modèle (entreprise, due diligence, implantation, secteur…), saisissez un sujet, générez ; export PDF ou markdown.'],
          zh: ['选模板（公司、尽调、市场进入、行业…），输入主题，生成；导出 PDF 或 markdown。'],
        },
      },
    ],
  },
